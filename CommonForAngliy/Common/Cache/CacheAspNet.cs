...
namespace Common.Caching
{
    ...
    public class CacheAspNet : ICache
    {
        ...
        private System.Web.Caching.CacheItemPriority ConvertToAspNetPriority(Common.Caching.CacheItemPriority priority)
        {
            if (priority == Common.Caching.CacheItemPriority.Default) { return System.Web.Caching.CacheItemPriority.Default; }
            if (priority == Common.Caching.CacheItemPriority.High) { return System.Web.Caching.CacheItemPriority.High; }
            if (priority == Common.Caching.CacheItemPriority.Low) { return System.Web.Caching.CacheItemPriority.Low; }
            if (priority == Common.Caching.CacheItemPriority.Normal) { return System.Web.Caching.CacheItemPriority.Normal; }
